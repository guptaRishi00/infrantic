  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl flex-col items-center pt-12 text-center">
        ...
        <h1
          id="hero-title"
          className="mt-6 text-[2.2rem] leading-[1] font-semibold tracking-[-0.04em] text-balance whitespace-pre-line text-ink motion-safe:animate-rise motion-safe:[animation-delay:80ms] sm:text-[2.75rem] lg:text-[3.1rem]"
        >
          {content.title}
        </h1>
        <p className="mt-4 max-w-[32rem] text-[15px] leading-[1.4] text-pretty text-zinc-600 motion-safe:animate-rise motion-safe:[animation-delay:160ms] sm:text-base sm:leading-[1.45]">
          {content.subtitle}
        </p>
        <div className="mt-7 flex flex-wrap justify-center gap-3 motion-safe:animate-rise motion-safe:[animation-delay:240ms]">
      ...
      <div className="relative mx-auto -mt-2 w-full max-w-[25.5rem]">
        ...
        <div className="pt-10 motion-safe:animate-rise motion-safe:[animation-delay:320ms]">
