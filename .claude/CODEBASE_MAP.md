...
## Identity
- Marketing site for **Infrantic, an AI, automation and custom-software company** ("AI & Automation Systems for Modern Businesses"). One-page home built from the company brief (2026-09-17): hero → problem → services → how we work → selected work → technology → approach → contact band → footer. **[v]**
